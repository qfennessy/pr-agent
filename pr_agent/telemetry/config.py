...
def parse_otel_bool(value) -> bool:
    """Parse host-provided telemetry flags without treating false strings as true."""
...
def get_otel_config() -> TelemetryConfig:
    ...
    if not parse_otel_bool(settings.get("OTEL.IS_ENABLED", False)):
